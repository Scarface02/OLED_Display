...
//  SSD1322_HW_drive_CS_low();
//  SSD1322_HW_drive_RESET_high();
//  SSD1322_HW_msDelay(1000);
//  SSD1322_HW_drive_RESET_low();
//  SSD1322_HW_msDelay(1000);
//  SSD1322_HW_drive_RESET_high();
//   
//  SSD1322_API_command(0xFD); /*SET COMMAND LOCK*/ 
//  SSD1322_API_data(0x12); /* UNLOCK */ 
//  SSD1322_API_command(0xAE); /*DISPLAY OFF*/ 
//  SSD1322_API_command(0xB3);/*DISPLAYDIVIDE CLOCKRADIO/OSCILLATAR FREQUANCY*/ 
//  SSD1322_API_data(0x91); 
//  SSD1322_API_command(0xCA); /*multiplex ratio*/ 
//  SSD1322_API_data(0x3F); /*duty = 1/64*/ 
//  SSD1322_API_command(0xA2); /*set offset*/ 
//  SSD1322_API_data(0x00);
//  SSD1322_API_command(0xA1); /*start line*/ 
//  SSD1322_API_data(0x00); 
//  SSD1322_API_command(0xA0); /*set remap*/
//  SSD1322_API_data(0x14); 
//  SSD1322_API_data(0x11);
//  	
//  SSD1322_API_command(0xAB); /*funtion selection*/ 
//  SSD1322_API_data(0x01); /* selection external vdd */ 
//  SSD1322_API_command(0xB4); /* */ 
//  SSD1322_API_data(0xA0);
//  SSD1322_API_data(0xfd); 
//  SSD1322_API_command(0xC1); /*set contrast current */ 
//  SSD1322_API_data(0x80); 
//  SSD1322_API_command(0xC7); /*master contrast current control*/ 
//  SSD1322_API_data(0x0f); 
//  	
//  SSD1322_API_command(0xB1); /*SET PHASE LENGTH*/
//  SSD1322_API_data(0xE2); 
//  SSD1322_API_command(0xD1); /**/
//  SSD1322_API_data(0x82); 
//  SSD1322_API_data(0x20); 
//  SSD1322_API_command(0xBB); /*SET PRE-CHANGE VOLTAGE*/ 
//  SSD1322_API_data(0x1F);
//  SSD1322_API_command(0xB6); /*SET SECOND PRE-CHARGE PERIOD*/
//  SSD1322_API_data(0x08); 
//  SSD1322_API_command(0xBE); /* SET VCOMH */ 
//  SSD1322_API_data(0x07); 
//  SSD1322_API_command(0xA6); /*normal display*/ 
//  SSD1322_API_command(0xAF); /*display ON*/   

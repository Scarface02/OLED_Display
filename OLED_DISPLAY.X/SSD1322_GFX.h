...
// FONTS // *** recommended to use
extern const GFXfont FreeMonoBold9pt7b;
extern const GFXfont Picopixel;
extern const GFXfont Tiny3x3a2pt7b; // smallest font, nearly illegible
extern const GFXfont FreeSerif9pt7b;
extern const GFXfont FreeSans9pt7b; // *** monospaced
extern const GFXfont FreeMono9pt7b;
extern const GFXfont FreeMonoOblique9pt7b;
extern const GFXfont Org_01; // *** legible small font, not monospaced
extern const GFXfont TomThumb; // small font with lots of available symbols
extern const GFXfont FreeMonoBold18pt7b; // big font only for startup title screen
extern const GFXfont Font5x7FixedMono; // *** mid sized font, monospaced, nicely legible
extern const GFXfont Font4x7Fixed;
